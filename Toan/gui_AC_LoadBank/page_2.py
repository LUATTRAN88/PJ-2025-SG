...
class RELAY_POWER:
    ...
    def create_layout(self,lay_timer_set, x,y,text):
        ...
        self.layout.place(x=x+48,y=y+10,width=48,height=66)
    ...
    def lamp_signal_relay(self):
        i1 = Image.open(get_path_img()+'lamp_on.png').resize((48,48))
        self.onr = ImageTk.PhotoImage(i1)
        a2 = Image.open(get_path_img()+'lamp_off.png').resize((48,48))
        self.offr = ImageTk.PhotoImage(a2)

        self.btn_on = Button(self.layout,image=self.onr,bg='white', bd=0,command=lambda:self.lamp_signal_relay())
        self.btn_on.place(x=0,y=18,width=48,height=48)
