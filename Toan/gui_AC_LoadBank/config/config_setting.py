...
class ConfigSetting:
    ...
    def read_file(self):
        with open('./config/config_setting.yml', 'r') as file:
        ...
        return prime_service['power_limit'], prime_service['voltage_LN_limit'], prime_service['temperature_limit']
    ...
    def write_file(self, power, voltage, temperature):
        ...
        with open('./config/config_setting.yml', 'w') as file:
