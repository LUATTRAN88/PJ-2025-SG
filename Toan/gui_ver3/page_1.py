...
class SIGNAL:
    ...
    #     self.relay_value.set(text)

        self.relay_sub(layout5)
    # relay 13, 14, 15, 16
    def relay_sub(self,layout5):
        self.layout13 = Frame(layout5,bg='#C1CDCD').place(x=387,y=13,width=28,height=114)
        self.layout14 = Frame(layout5,bg='#C1CDCD').place(x=419.2,y=13,width=28,height=114)
        self.layout15 = Frame(layout5,bg='#C1CDCD').place(x=451.4,y=13,width=28,height=114)
        self.layout16 = Frame(layout5,bg='#C1CDCD').place(x=483.6,y=13,width=28,height=114)

        # relay 13
        self.photo13 = Image.open('lamp.png')
        self.pic13 = ImageTk.PhotoImage(self.photo13)
        self.lb_lamp = Label(self.layout13, bg='#C1CDCD',image=self.pic13).place(x=389,y=655,width=24,height=38)

        font13 = tkFont.Font(family='Helvetica', size=8)
        self.lb_relay = Label(self.layout13, bg='#C1CDCD',font=font13,fg='black',text='RL13').place(x=387,y=624,width=28,height=33)

        fontreva = tkFont.Font(family='Helvetica', size=9)
        self.lb_relay_val = Label(self.layout13, bg='#C1CDCD',font=fontreva,text='Fan',fg='black').place(x=387,y=688,width=28,height=33)

        # relay 14
        self.photo14 = Image.open('lamp.png')
        self.pic14 = ImageTk.PhotoImage(self.photo14)
        self.lb_lamp = Label(self.layout14, bg='#C1CDCD',image=self.pic14).place(x=421.2,y=655,width=24,height=38)

        font14 = tkFont.Font(family='Helvetica', size=8)
        self.lb_relay = Label(self.layout14, bg='#C1CDCD',font=font14,fg='black',text='RL14').place(x=419.2,y=624,width=28,height=33)

        fontreva = tkFont.Font(family='Helvetica', size=9)
        self.lb_relay_val = Label(self.layout14, bg='#C1CDCD',font=fontreva,text='Alrm',fg='black').place(x=419.2,y=688,width=28,height=33)

        # relay 15
        self.photo15 = Image.open('lamp.png')
        self.pic15 = ImageTk.PhotoImage(self.photo14)
        self.lb_lamp = Label(self.layout15, bg='#C1CDCD',image=self.pic15).place(x=453.4,y=655,width=24,height=38)

        font15 = tkFont.Font(family='Helvetica', size=8)
        self.lb_relay = Label(self.layout15, bg='#C1CDCD',font=font15,fg='black',text='RL15').place(x=451.4,y=624,width=28,height=33)

        fontreva = tkFont.Font(family='Helvetica', size=9)
        self.lb_relay_val = Label(self.layout15, bg='#C1CDCD',font=fontreva,text='Spar',fg='black').place(x=451.4,y=688,width=28,height=33)

        # relay 16
        self.photo16 = Image.open('lamp.png')
        self.pic16 = ImageTk.PhotoImage(self.photo14)
        self.lb_lamp = Label(self.layout16, bg='#C1CDCD',image=self.pic16).place(x=485.6,y=655,width=24,height=38)

        font16 = tkFont.Font(family='Helvetica', size=8)
        self.lb_relay = Label(self.layout15, bg='#C1CDCD',font=font16,fg='black',text='RL16').place(x=483.6,y=624,width=28,height=33)

        fontreva = tkFont.Font(family='Helvetica', size=9)
        self.lb_relay_val = Label(self.layout16, bg='#C1CDCD',font=fontreva,text='Spar',fg='black').place(x=483.6,y=688,width=28,height=33)
