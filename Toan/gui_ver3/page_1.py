...
class PAGE1:
    ...
    def label_powtime(self):
        ...
        self.lb_power_val = Label(self.layout4,bg='white',font=fontpo,text='58.1 KW',fg='red').place(x=246,y=59,width=265,height=75)

    def tab_button(self):
        self.photo1 = Image.open('up1.png').resize((50,46))
        self.pic1 = ImageTk.PhotoImage(self.photo1)
        self.btn_powset_up = Button(self.layout3,bd=0, bg='white',image=self.pic1).place(x=462,y=43,width=50,height=46)

        self.photo2 = Image.open('down1.png').resize((50,46))
        self.pic2 = ImageTk.PhotoImage(self.photo2)
        self.btn_powset_down = Button(self.layout3,bd=0, bg='white',image=self.pic2).place(x=462,y=98,width=50,height=46)

        self.photo3 = Image.open('up1.png').resize((50,46))
        self.pic3 = ImageTk.PhotoImage(self.photo3)
        self.btn_time_up = Button(self.layout3,bd=0,bg='white',image=self.pic3).place(x=462,y=232,width=50,height=46)

        self.photo4 = Image.open('down1.png').resize((50,46))
        self.pic4 = ImageTk.PhotoImage(self.photo4)
        self.btn_time_down = Button(self.layout3,bd=0,bg='white',image=self.pic4).place(x=462,y=287,width=50,height=46)
    ...
    def label_power(self):
        ...
        self.lb_L1_power = Label(self.layout4,bg='white',font=fonl1t,text='19.5',fg='red').place(x=66,y=201,width=69,height=39)
        self.lb_L1_volt_Ln = Label(self.layout4,bg='white',font=fonl1t,text='231.8',fg='red').place(x=137,y=201,width=69,height=39)
        self.lb_L1_volt_cur = Label(self.layout4,bg='white',font=fonl1t,text='28.0',fg='red').place(x=209,y=201,width=70,height=39)
        self.lb_L1_volt_pf = Label(self.layout4,bg='white',font=fonl1t,text='0.99',fg='red').place(x=281,y=201,width=70,height=39)
        self.lb_L1_volt_ll = Label(self.layout4,bg='white',font=fonl1t,text='401.5',fg='red').place(x=427,y=201,width=71,height=39)
        ...
        self.lb_L2_power = Label(self.layout4,bg='white',font=fonl2t,text='19.2',fg='orange').place(x=66,y=241,width=69,height=39)
        self.lb_L2_volt_ln = Label(self.layout4,bg='white',font=fonl2t,text='232.1',fg='orange').place(x=137,y=241,width=69,height=39)
        self.lb_L2_cur = Label(self.layout4,bg='white',font=fonl2t,text='27.6',fg='orange').place(x=209,y=241,width=70,height=39)
        self.lb_L2_pf = Label(self.layout4,bg='white',font=fonl2t,text='0.98',fg='orange').place(x=282,y=241,width=68,height=39)
        self.lb_L2_volt_ll = Label(self.layout4,bg='white',font=fonl2t,text='402.0',fg='orange').place(x=427,y=241,width=72,height=39)
        ...
        self.lb_L3_power = Label(self.layout4,bg='white',font=fonl3t,text='19.4',fg='blue').place(x=66,y=281,width=69,height=39)
        self.lb_L3_volt_ln = Label(self.layout4,bg='white',font=fonl3t,text='232.7',fg='blue').place(x=137,y=281,width=69,height=39)
        self.lb_L3_volt_cur = Label(self.layout4,bg='white',font=fonl3t,text='27.8',fg='blue').place(x=209,y=281,width=70,height=39)
        self.lb_L3_volt_pf = Label(self.layout4,bg='white',font=fonl3t,text='1.0',fg='blue').place(x=282,y=281,width=68,height=39)
        self.lb_L3_volt_ll = Label(self.layout4,bg='white',font=fonl3t,text='403.1',fg='blue').place(x=427,y=281,width=72,height=39)
        ...
        self.lb_freq_pow_vol = Label(self.layout4,bg='white',font=fonl4t,text='50.2 Hz',fg='black').place(x=66,y=321,width=141,height=39)
        self.lb_freq_cur = Label(self.layout4,bg='white',font=fonl4t,text='35.2 ºC',fg='black').place(x=282,y=321,width=216,height=39)
