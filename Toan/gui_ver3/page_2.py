...
class PAGE2:
    ...
    def create_layout(self,l1):
        ...
        self.layout6 = Frame(self.layout3, bg='white')
    ...
    def label_power_set(self):
        ...
        self.lb_power_set = Label(self.layout3,bg='white',font=fontps,text='POWER SET (KW)',fg='#00CD00').place(x=10,y=18,width=500,height=62)
...
class SIGNAL_POWER:
    ...
    def create_layout(self,layout6,text,x,y):
        self.layout = Frame(layout6,bg='white')
        self.layout.place(x=x,y=y,width=85,height=144)

        fonre = tkFont.Font(family='Helvetica', size=16)
        self.lb_relay1 = Label(self.layout,bg='white',font=fonre,text=text).place(x=13,y=9,width=55,height=34)
